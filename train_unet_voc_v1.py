...
def sweep_train(config_defaults=None):
    ...
    with wandb.init(config=config_defaults):  
        ...
        wandb.config.architecture_name = "U-NET"
        wandb.config.dataset_name = "VOC"

        train(model_type='standard_unet')

def train(model_type='standard_unet'):
    ...
    for epoch in range(num_epochs):
        ...
        try:
          wandb.log({
              ...
              'masks': wandb.Image(masks[0].float().cpu()),
